...
const Card: React.FC<CardProps> = ({ tag, icon }) => {
  ...
  return (
    <div className="group">
      <div style={myFont.style} className="h-[22rem] px-5 py-5 cursor-pointer overflow-hidden w-[15rem] flex flex-col justify-between bg-transparent border-[1px] border-[#ffffff33] rounded-2xl relative transition-all ease-in-out duration-300">
